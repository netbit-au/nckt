...
/* Enable special compilation for MPI with mpicc */
/* #undef ENABLE_MPI */
...
/* Define to 1 if you have the `nc-dap' library (-lnc-dap). */
...
/* Define if C++ compiler implements namespaces */
...
#define PACKAGE_BUGREPORT "help@nco.sf.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NCO netCDF Operators"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NCO netCDF Operators 4.0.2"
...
/* Location of UDUnits2 data file */
#define UDUNITS2_PATH ""
