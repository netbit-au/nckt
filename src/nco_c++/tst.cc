// $Header: /cvsroot/nco/nco/src/nco_c++/tst.cc,v 1.33 2010/01/05 20:02:18 zender Exp $
...
int main(int argc,char **argv)
{
  ...
  const std::string CVS_Date("$Date: 2010/01/05 20:02:18 $"); // [sng] CVS date string
  const std::string CVS_Header("$Header: /cvsroot/nco/nco/src/nco_c++/tst.cc,v 1.33 2010/01/05 20:02:18 zender Exp $"); // [sng] CVS header string
  const std::string CVS_Id("$Id: tst.cc,v 1.33 2010/01/05 20:02:18 zender Exp $"); // [sng] CVS identification string
  const std::string CVS_Revision("$Revision: 1.33 $"); // [sng] CVS revision string
