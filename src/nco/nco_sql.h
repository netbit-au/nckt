/* $Header: /cvsroot/nco/nco/src/nco/nco_sql.h,v 1.00 2014/02 20:02:18 zender Exp $ */
...
void
nso_sql_prn_idx    /* [fnc] Print multiple hyperslab indices  */
(lmt_all_sct * lmt_lst);

void
nso_sql_clc_cnt    /* [fnc] Calculate size of  multiple hyperslab */
(lmt_all_sct *lmt_lst);

void
nso_sql_wrp_splt /* [fnc] Split wrapped dimensions */
(lmt_all_sct *lmt_lst);

nco_bool           /* O return true if limits overlap */
nso_sql_ovl        /* [fnc] see if limits overlap */
(lmt_all_sct *lmt_lst);
...
void
nso_sql_qsort_srt  /* [fnc] sort limits by srt values  */
(lmt_all_sct *lmt_lst);

void
nso_sql_lmt_all_int     /* [fnc] Initilaize lmt_all_sct's */
(int in_id,
...
nso_sql_rec_clc /* Multi slab algorithm (recursive routine) */
...
nso_sql_min_idx /* [fnc] Find minimum values in current and return minimum value */
...
void
nso_sql_ram_2_dsk   /* [fnc] convert hyperlsab indices into indices relative to disk */
...
void
nso_sql_prn_var_val   /* [fnc] Print variable data */
(const int in_id, /* I [id] netCDF input file ID */
...
void
nso_sql_var_get  /* [fnc] Get var data from disk taking accound of multihyperslabs */
(const int in_id,  /* I [id] netCDF input file ID */
 var_sct *var_in,
 lmt_all_sct * const * lmt_lst, /* I multi-hyperslab limits */
 int nbr_dmn_fl); /* I [nbr] Number of multi-hyperslab limits */
...
void
nso_sql_var_val_cpy /* [fnc] Copy variables data from input to output file */
